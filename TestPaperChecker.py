...
"font: 12pt \"Arial\";")
        ...
        self.UploadImageBtn.clicked.connect(self.browsefiles)  
    ...
    #converts QPixmap to QImage
        ...
        #reads answer key from text file
        ...
        #assign answer key value to corresponding integer based on the possible answer key dictionary         
...
# Finding the shaded bubble    
    # loop over the sorted contours
            ...
            # the bubble should be shaded to consider it as an answer
        ...
        #parameters for writing score in image
        ...
        #changing the contour color to red 
    ...
    def resizeImage(self,img):
        if img.shape[0]==2048 and img.shape[1]==1488:
            return img 
        else:
            img=cv.resize(img,(1488,2048),interpolation=cv.INTER_AREA)
            return img
    ...
    def saveAddTestAnswerKey(self):
        ...
        self.window.show()
        QtCore.QTimer.singleShot(500, self.window.close)
        ...
        for row in range(rowCount):
            for column in range(columnCount):
                ...
                if(widgetItem and widgetItem.text):
                    rowData.append(widgetItem.text()[0])
                else:
                    rowData.append('NULL')
